<div>
    <footer class="bg-gray-900 " aria-labelledby="footer-heading">
        ...
        <div class="px-5 py-12 mx-auto max-w-7xl lg:py-6 md:px-12 lg:px-20">
          ...
          "> Store Name Here </a>
              <p class="w-1/2 mt-2 text-sm text-gray-300"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, necessitatibus aliquid quas laboriosam sint soluta rem in, quaerat illum explicabo dolorem reiciendis amet incidunt distinctio iure esse, ut qui quae!</p>
            </div>
            <div class="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 class=" text-xs font-semibold tracking-wider text-red-600 uppercase"> Solutions </h3>
                ...
                <div class="mt-12 md:mt-0">
                  <h3 class=" text-xs font-semibold tracking-wider text-red-600 uppercase"> Support </h3>
                  <ul role="list" class="mt-4 space-y-4">
                    <li>
    ...
    ">
          ...
          <div class="mt-8 md:mt-0 md:order-1">
            <span class="mt-2 text-sm font-light text-gray-300"> Copyright © 2020 - 2021 <a href="https://wickedlabs.dev" class="mx-2 text-wickedblue hover:text-gray-300" rel="noopener noreferrer">@wickedlabsHQ</a>. Since 2020 </span>
          </div>
        </div>
      </footer>
